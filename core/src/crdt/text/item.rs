...
impl Item {
    /// Create a new item
    pub fn new(id: ItemId, content: String, left: Option<ItemId>, right: Option<ItemId>) -> Self {
        Self {
            client: id.client,
            id,
            content,
    ...
    pub fn new_char(id: ItemId, ch: char, left: Option<ItemId>, right: Option<ItemId>) -> Self {
