...
- [x] Access tokens generated with correct claims
- [x] Refresh tokens generated with extended expiry
- [x] Tokens pass validation by JwtValidator
- [x] Expiry times configurable
