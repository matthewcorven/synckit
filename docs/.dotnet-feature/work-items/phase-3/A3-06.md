...
- [x] Non-auth messages require authentication
- [x] Subscribe requires read permission
- [x] Delta requires write permission
- [x] Awareness requires awareness permission
- [x] Proper error messages sent
