...
- [x] AwarenessState holds all standard fields
- [x] Custom state supported via dictionary
- [x] Clock tracks version for each client
- [x] Expiration tracked for cleanup
