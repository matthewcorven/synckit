...
1. Create `IStorageAdapter.cs` interface (replaces legacy `IDocumentStore`)
...
**Files Created:**
- [IStorageAdapter.cs](../../../../server/csharp/src/SyncKit.Server/Storage/IStorageAdapter.cs) - Storage adapter interface (replaces IDocumentStore)
- [InMemoryStorageAdapter.cs](../../../../server/csharp/src/SyncKit.Server/Storage/InMemoryStorageAdapter.cs) - Thread-safe in-memory implementation
- [InMemoryDocumentStoreTests.cs](../../../../server/csharp/src/SyncKit.Server.Tests/Sync/InMemoryDocumentStoreTests.cs) - Tests updated to cover adapter-based behavior

**Files Modified:**
- [WebSocketExtensions.cs](../../../../server/csharp/src/SyncKit.Server/WebSockets/WebSocketExtensions.cs) - Registered `IStorageAdapter` in DI container (InMemoryStorageAdapter)
