...
- [x] Connections tracked by ID
- [x] Max connection limit enforced
- [x] Lookup by document subscription works
- [x] Lookup by user ID works
- [x] Broadcast to document works
- [x] Thread-safe operations
- [x] RemoveConnectionAsync cleans up all subscriptions (document + awareness)
- [x] CloseAllAsync closes all connections gracefully (for shutdown)
