...
- [x] Connection manages WebSocket lifecycle
- [x] Protocol detected on first message
- [x] Messages parsed with correct handler
- [x] Send works for both protocols
- [x] Clean disposal of resources
- [x] ArrayPool used for receive buffers (returned on dispose)
