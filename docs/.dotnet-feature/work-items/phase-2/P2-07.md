...
- [x] Server sends PING every 30s
- [x] Server responds to client PING with PONG
- [x] Connection terminated if no PONG within 60s
- [x] Heartbeat interval/timeout configurable
