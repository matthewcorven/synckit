...
- [x] JSON detected when message starts with `{`
- [x] Binary detected for all other first bytes
- [x] Detection happens only once per connection
- [x] Detection logged for debugging
- [x] Same detection logic as TypeScript
