...
Dog:
- Registration/Tracking # (system-generated)
- Breed
- Registered Name
- DOB
- Color
...
- Generated by the system on **successful submit**.
- Format: `TrialSlug-0001` (zero-padded sequence), where the sequence resets per trial.
